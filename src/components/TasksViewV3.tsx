...
import { Award, Calendar, DollarSign, User, ArrowLeft, Search, ChevronDown, ChevronUp, ChevronRight, MessageCircle, Bell, Settings, X, Eye, EyeOff, FileText, Handshake, CheckCircle, Archive, MessageCircleMore, MapPin, CircleDollarSign, FileCheck, TrendingUp } from "lucide-react";
...
type TaskType = "new-chat" | "terms-fixing" | "showing-schedule" | "deposit-ready" | "deal-closed" | "commission-received";
...
export function TasksViewV3({ onBack, onOpenChat }: TasksViewV3Props) {
  ...
  const filteredTasks = tasks.filter((task) => {
    ...
    if (statusFilter === "mls-showing" && task.type !== "showing-schedule") return false;
    if (statusFilter === "mls-deposit" && task.type !== "deposit-ready") return false;
    if (statusFilter === "mls-closed" && task.type !== "deal-closed") return false;
    if (statusFilter === "mls-commission-received" && task.type !== "commission-received") return false;
  ...
  const getStatusCount = (filter: string) => {
    ...
    // МЛС фильтры
    if (filter === "mls-all") return currentTasks.filter(t => t.status !== "completed").length;
    if (filter === "mls-new-chat") return currentTasks.filter(t => t.type === "new-chat").length;
    if (filter === "mls-terms") return currentTasks.filter(t => t.type === "terms-fixing").length;
    if (filter === "mls-showing") return currentTasks.filter(t => t.type === "showing-schedule").length;
    if (filter === "mls-deposit") return currentTasks.filter(t => t.type === "deposit-ready").length;
    if (filter === "mls-closed") return currentTasks.filter(t => t.type === "deal-closed").length;
    if (filter === "mls-commission-received") return currentTasks.filter(t => t.type === "commission-received").length;
          ...
          <div>
            ...
            {isMlsExpanded && (
              ...
              >
                ...
                <span className={`text-[12px] px-2 py-0.5 rounded-full ${
                  statusFilter === "mls-all" ? "bg-[#2D9CDB] text-white" : "bg-gray-200 text-gray-600"
                }`}>
              ...
              >
                ...
                <span className={`text-[12px] px-2 py-0.5 rounded-full ${
                  statusFilter === "mls-new-chat" ? "bg-[#2D9CDB] text-white" : "bg-gray-200 text-gray-600"
                }`}>
              ...
              >
                ...
                <span className={`text-[12px] px-2 py-0.5 rounded-full ${
                  statusFilter === "mls-terms" ? "bg-[#2D9CDB] text-white" : "bg-gray-200 text-gray-600"
                }`}>
              ...
              >
                ...
                <span className={`text-[12px] px-2 py-0.5 rounded-full ${
                  statusFilter === "mls-showing" ? "bg-[#2D9CDB] text-white" : "bg-gray-200 text-gray-600"
                }`}>
              ...
              >
                ...
                <span className={`text-[12px] px-2 py-0.5 rounded-full ${
                  statusFilter === "mls-deposit" ? "bg-[#2D9CDB] text-white" : "bg-gray-200 text-gray-600"
                }`}>
              ...
              >
                ...
                <span className={`text-[12px] px-2 py-0.5 rounded-full ${
                  statusFilter === "mls-closed" ? "bg-[#2D9CDB] text-white" : "bg-gray-200 text-gray-600"
                }`}>
              ...
              >
                ...
                <span className={`text-[12px] px-2 py-0.5 rounded-full ${
                  statusFilter === "mls-commission-received" ? "bg-[#2D9CDB] text-white" : "bg-gray-200 text-gray-600"
                }`}>
